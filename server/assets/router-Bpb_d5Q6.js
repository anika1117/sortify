...
const appCss = "/sortify/assets/styles-B5YA1-ws.css";
...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Interactive sorting algorithm visualizer with step-by-step animations." },
      { name: "author", content: "Sai Anika Bompally" },
      { property: "og:title", content: "Sortify — Sorting Algorithm Visualizer" },
      { property: "og:description", content: "Beautifully animated visualizations of classic sorting algorithms." },
...
const $$splitComponentImporter = () => import("./index-BFubpaLd.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Interactive, step-by-step visualization of bubble, selection, and insertion sort with 3D mode, full playback controls, and real-time complexity insights."
    }, {
      property: "og:title",
      content: "Sortify — Sorting Algorithm Visualizer"
    }, {
      property: "og:description",
      content: "Beautifully animated, step-controlled visualizations of classic sorting algorithms."
    }]
  }),
