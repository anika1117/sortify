...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BzU8Y4w3.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Bpb_d5Q6.js").then((n2) => n2.a),
...
var ROUTER_BASEPATH = "sortify";
var SERVER_FN_BASE = "/sortify/_serverFn/";
